...
* lightningcash.conf: contains configuration settings for lightningcashd or lightningcash-qt
* lightningcashd.pid: stores the process id of lightningcashd while running
...
* debug.log: contains debug information and general logging generated by lightningcashd or lightningcash-qt
