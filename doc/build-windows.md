...
for Ubuntu Xenial does not produce working executables for some of the LightningCash Core applications.
...
The next three steps are an example of how to acquire the source in an appropriate way.
    ...
    cd /usr/src
    sudo git clone https://github.com/lightningcash-project/lightningcash.git
...
causes two of the lightningcash executables to crash shortly after start up. The bug is related to the
