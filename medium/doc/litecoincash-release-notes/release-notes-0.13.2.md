LightningCash Core version 0.13.2 is now available from:
  ...
  <https://download.lightningca.sh/lightningcash0.13.2.1/>
...
The two phases are distinct in the LightningCashQt GUI. During the first one,
...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of lightningcash they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of lightningcash being spent is exactly
