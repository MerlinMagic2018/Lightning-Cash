LightningCash Core version 0.10.2.2 is now available from:
  ...
  <https://download.lightningca.sh/lightningcash0.10.2.2/>
...
installer (on Windows) or just copy over /Applications/LightningCashQt (on Mac) or
...
is included in as separate release-notes.  This section describes the LightningCashspecific differences.
