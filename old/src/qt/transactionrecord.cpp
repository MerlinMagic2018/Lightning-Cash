    ...
    if (nNet > 0 || wtx.IsCoinBase())
    {
        ...
        for(unsigned int i = 0; i < wtx.tx->vout.size(); i++)
        {
            ...
            if(mine)
            {
                ...
                if (wtx.IsCoinBase())
                {
                    // LightningCash Gold: Hive: Check for a Hivemined coinbase transaction
    ...
    else
    {
        ...
        else if (fAllFromMe)
        {
            ...
            for (unsigned int nOut = 0; nOut < wtx.tx->vout.size(); nOut++)
            {
                ...
                CTxDestination address;
                // LightningCash Gold: Hive: Check for a BCT
...
void TransactionRecord::updateStatus(const CWalletTx &wtx)
{
    ...
    // LightningCash Gold: Hive: Do the same for hivemined transactions
