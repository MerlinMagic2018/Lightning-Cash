...
UniValue GetNetworkHashPS(int lookup, int height) {
	...
	lookup = IsHive12Enabled(pb->nHeight) ? 1 : pb->nHeight % Params().GetConsensus().DifficultyAdjustmentInterval() + 1;   // LightningnCash-: Hive 1.1: Taking the opportunity to provide a more sensible default.
