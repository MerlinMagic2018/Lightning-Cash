...
void ThreadScriptCheck() {
    RenameThread("lightningcashscriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // LightningCash : Ensure that lastScryptBlock+1320700 coinbase TX pays to the premine address
