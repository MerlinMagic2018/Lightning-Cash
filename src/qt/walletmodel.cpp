...
bool WalletModel::createBees(int beeCount, bool communityContrib, QWidget *parent, double beePopIndex) {
    ...
    if (beePopIndex > 90)
        questionString.append("<br /><span style='color:#aa0000;'><b>WARNING:</b> Global Index is high and bees may not be profitable. If you still want to create bees, know that they will also cost more than normal price since Global Index is high. Please ensure you understand the consequences before proceeding.</span><br />");
