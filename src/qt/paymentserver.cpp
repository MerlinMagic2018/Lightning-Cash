...
const char* BIP71_MIMETYPE_PAYMENT = "application/lightningcashpayment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/lightningcashpaymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/lightningcashpaymentrequest";
