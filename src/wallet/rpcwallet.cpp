...
UniValue createbees(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "3. \"honey_address\"        (string, optional) The LNC address to receive rewards for blocks mined by bee(s) created in this transaction.\n"
			"4. \"change_address\"       (string, optional, default pool address) The LNC address to receive the change.\n"
            "\nResult:\n"
            "\"txid\"                    (string) The transaction id.\n"
            "\nExamples:\n"
