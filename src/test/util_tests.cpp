...
BOOST_AUTO_TEST_CASE(util_FormatMoney)
{
    ...
    BOOST_CHECK_EQUAL(FormatMoney(COIN/100000000), "0.00");     // LightningCash Gold: Coin scale
}
...
BOOST_AUTO_TEST_CASE(util_ParseMoney)
{
    ...
    BOOST_CHECK_EQUAL(ret, COIN/10000000);
    BOOST_CHECK(!ParseMoney("0.00000001", ret));		// LightningCash Gold: Coinscale - Test should fail
